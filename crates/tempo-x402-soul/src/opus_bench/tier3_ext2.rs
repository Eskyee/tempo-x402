...
#[test] fn t5() { assert_eq!(encode("hello"), "85121215"); }"#),
        ...
        problem("opus-mystery-pairs", "tier3", "Infer what this function does.", "",
...
#[test] fn t5() { let mut r = pairs(&[0,5,3,2], 5); r.sort(); assert_eq!(r, vec![(0,5),(2,3)]); }"#),
        ...
        problem("opus-mystery-grid", "tier3", "Infer the grid operation.", "",
...
#[test] fn t5() { assert_eq!(count(&[&[1,1,0],[1,0,0],[0,0,1]]), 2); }"#),
        ...
        problem("opus-mystery-bits", "tier3", "Infer the bit operation.", "",
...
#[test] fn t6() { assert_eq!(process(15), 4); }"#),
        ...
        problem("opus-mystery-nest", "tier3", "Infer the nesting function.", "",
...
#[test] fn t6() { assert_eq!(depth(""), 0); }"#),
        ...
        problem("opus-mystery-spiral", "tier3", "Infer the spiral function.", "",
...
#[test] fn t5() { assert_eq!(spiral(&[&[1],[2],[3]]), vec![1,2,3]); }"#),
        ...
        problem("opus-mystery-digit-sum", "tier3", "Infer the digit operation.", "",
